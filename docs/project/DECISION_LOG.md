...
| 2026-09-22 / DEC-058 / `f52da3f` | Accept tip `f52da3f` as the product candidate SHA. Keep confirmation tokens at 24h. Remember-this-device is how returning participants see all classes; encourage it on confirmation (prominent, default-checked, clear consent). Expired confirmation never hard-404s — clear expired state + View your bookings when remembered. Next work is conventional hardening + QA on that candidate lineage only. | Product candidate freeze; supersedes DEC-055 presentation conflicts. |
