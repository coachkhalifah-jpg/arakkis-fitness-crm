...
- Branch: `fix/integration-and-ux` (hardening on the candidate lineage)
- Remote: `coachkhalifah-jpg/arakkis-fitness-crm`
- Current milestone: conventional hardening and QA against the product candidate SHA; no re-architecture.
...
Owner-controlled candidate deploy + smoke QA on the DEC-058 remember/expiry hardening, then staging validation: migration replay, Auth, backups, monitoring, UAT, and legal-gate verification.
