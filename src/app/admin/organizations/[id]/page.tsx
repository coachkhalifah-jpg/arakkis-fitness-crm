...
export default async function OrganizationDetailPage({
  ...
  return (
    <section className="mx-auto max-w-5xl px-6 py-12">
      <Link className="text-sm text-brand" href="/admin/organizations">
        ← Organizations
      </Link>
      <h1 className="mt-3 text-3xl font-semibold text-ink">{organization.name}</h1>
      <p className="mt-2 text-slate-600">{organization.active_status}</p>
