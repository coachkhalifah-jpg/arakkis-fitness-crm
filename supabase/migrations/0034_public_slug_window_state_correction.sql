-- Forward-only correction for public slug availability states.
-- Migration 0029 remains immutable; preserve its projection and restore explicit
-- registration opening/closing states after the function replacement.
